...
interface CreateStartupStepsParams {
  ...
  /** Verifies / downloads managed node binaries into the app data directory.
   *  Receives an updateProgress callback.
   *  A no-op when there are no local nodes configured. */
